  ...
  return (
    <motion.header 
      ...
      className={`sticky top-0 z-50 transition-all duration-300 ${
        isScrolled 
          ? 'bg-white/98 backdrop-blur-md shadow-md border-b border-cyan-100/80 py-2' 
          : 'bg-white/95 backdrop-blur-sm border-b border-slate-200/80 py-2.5 lg:py-2'
      }`}
    >
      <div className="container-custom">
        <div className="flex items-center justify-between">
          ...
          <a 
            ...
            className="flex items-center gap-2 group focus-visible:ring-2 focus-visible:ring-cyan-500 rounded-xl p-1 -m-1 transition-transform active:scale-[0.98]"
          ...
          >
            <img 
              ...
              fetchPriority="high"
              decoding="async"
              className="h-14 sm:h-18 lg:h-20 max-h-20 w-auto object-contain transition-transform group-hover:scale-103 drop-shadow-sm"
            />
          </a>
          ...
          <div className="flex md:hidden items-center gap-2">
            <Button
              ...
              variant="accent"
              size="sm"
              className="px-3 py-2 bg-amber-400 text-slate-950 font-bold"
            ...
            <button
              ...
              className="p-2.5 rounded-xl text-slate-800 hover:text-slate-950 hover:bg-slate-100 focus-visible:ring-2 focus-visible:ring-blue-900 focus:outline-none transition-colors"
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          ...
          >
            <div className="container-custom py-5 space-y-2 text-left">
                  ...
                  return (
                    <a
                      ...
                      className={`px-4 py-3 rounded-xl text-base font-bold transition-colors flex items-center justify-between ${
                        isActive
                          ? 'bg-blue-50 text-blue-950 border-l-4 border-blue-950 pl-3'
              ...
              <div className="pt-4 border-t border-slate-100 flex flex-col gap-2.5">
                <Button 
                  ...
                  variant="accent" 
                  size="md"
                  className="w-full justify-center gap-2 bg-amber-400 hover:bg-amber-500 text-slate-950 font-black"
